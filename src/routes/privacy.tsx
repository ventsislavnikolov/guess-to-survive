      ...
      <section className="mx-auto max-w-3xl space-y-10">
        <Block title="1. What we collect">
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            ...
            <li>• Game data (games joined, picks made, outcomes, and related activity).</li>
            <li>• Payment metadata (payment status and identifiers). Card details are processed by Stripe.</li>
            <li>• Technical data (device/browser info, basic logs for security and reliability).</li>
          </ul>
        </Block>
        ...
        <Block title="4. Cookies and local storage">
          <p className="text-sm text-muted-foreground">
            We use essential cookies or local storage for authentication, security, and preferences (like theme). We
            may also use analytics to understand usage and improve the Service.
          </p>
        </Block>

        <Block title="5. Data retention">
          <p className="text-sm text-muted-foreground">
            We retain personal data while your account is active. If you delete your account, we may anonymize
            personal data while retaining non-personal game records needed for integrity and audit.
          </p>
        </Block>
        ...
        <Block title="7. Security">
          <p className="text-sm text-muted-foreground">
            We use reasonable technical measures to protect your data. No method of transmission or storage is 100%
        ...
        <div className="rounded-2xl border border-border bg-card/70 p-5 text-xs text-muted-foreground">
          ...
          <p className="mt-2">
            This page is provided for product completeness and does not constitute legal advice.
          </p>
        </div>
      </section>
    </div>
