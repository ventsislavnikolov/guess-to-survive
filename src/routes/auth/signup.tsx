        ...
        <CardContent>
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <p className="text-muted-foreground text-xs">
              Responsible gaming: paid games involve real money. Set limits that
              work for you, and use self-exclusion any time from your profile.
            </p>
          </form>
