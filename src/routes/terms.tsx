      ...
      <section className="relative overflow-hidden rounded-3xl border border-border/80 bg-[linear-gradient(135deg,rgba(16,185,129,0.18),transparent_42%),linear-gradient(225deg,rgba(56,189,248,0.14),transparent_45%)] p-6 shadow-sm dark:bg-[linear-gradient(135deg,rgba(16,185,129,0.2),transparent_42%),linear-gradient(225deg,rgba(56,189,248,0.18),transparent_45%)] sm:p-10">
        ...
        <div className="relative">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <Button asChild className="h-10 gap-2 rounded-xl px-5" size="sm" variant="outline">
      ...
      <section className="mx-auto max-w-3xl space-y-10">
        ...
        <Block title="4. Game rules (high level)">
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            ...
            <li>• If your team wins, you survive. If your team loses or draws, you are eliminated.</li>
            <li>• You cannot pick the same team twice in the same game.</li>
            <li>• If you fail to pick, the Service may auto-assign an eligible team.</li>
          </ul>
          <p className="mt-3 text-sm text-muted-foreground">
            For the full explainer and examples, see the{' '}
            <Link className="underline underline-offset-4 hover:text-foreground" to="/how-it-works">
              How it works
            </Link>{' '}
            page.
          </p>
        ...
        <Block title="5. Paid games, payments, and fees">
          <p className="text-sm text-muted-foreground">
            Paid games require an entry fee. Payments are processed by Stripe. The Service may show and collect
            applicable processing fees during checkout.
          </p>
        </Block>

        <Block title="6. Refunds and cancellations">
          <p className="text-sm text-muted-foreground">
            Refund scenarios may include (for example) game cancellation for not meeting minimum players, manager
            kicks, or other cases defined by the game configuration and platform policies. Where refunds apply, they
        ...
        <Block title="7. Responsible gaming">
          <p className="text-sm text-muted-foreground">
            Only play with money you can afford to lose. You may use the self-exclusion controls in your profile to
            block yourself from paid games for a period of time.
          </p>
        </Block>

        <Block title="8. Prohibited conduct">
          <p className="text-sm text-muted-foreground">
            You agree not to misuse the Service, attempt to access accounts you do not own, or interfere with normal
            operation. We may suspend or terminate accounts that violate these Terms.
          </p>
        </Block>

        <Block title="9. Third-party services">
          <p className="text-sm text-muted-foreground">
            The Service uses third-party providers for infrastructure, authentication, payments, and email delivery.
        ...
        <Block title="10. Disclaimers">
          <p className="text-sm text-muted-foreground">
            The Service is provided “as is” and “as available.” Past performance does not guarantee future results.
            Match data and results are sourced from third parties and may be delayed or corrected.
          </p>
        </Block>
        ...
        <Block title="12. Contact">
          <p className="text-sm text-muted-foreground">
            ...
            <a className="underline underline-offset-4 hover:text-foreground" href="mailto:privacy@guesstosurvive.com">
        ...
        <div className="rounded-2xl border border-border bg-card/70 p-5 text-xs text-muted-foreground">
          <p className="font-medium text-foreground">Note</p>
          <p className="mt-2">
            This page is provided for product completeness and does not constitute legal advice. If you need
            jurisdiction-specific terms, consult a qualified attorney.
          </p>
        </div>
      </section>
    </div>
