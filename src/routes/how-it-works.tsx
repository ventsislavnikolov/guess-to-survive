    ...
    <div className="space-y-14">
      <section className="relative overflow-hidden rounded-3xl border border-border/80 bg-[linear-gradient(135deg,rgba(56,189,248,0.18),transparent_40%),linear-gradient(225deg,rgba(16,185,129,0.18),transparent_42%)] p-6 shadow-sm sm:p-10 dark:bg-[linear-gradient(135deg,rgba(56,189,248,0.22),transparent_40%),linear-gradient(225deg,rgba(16,185,129,0.22),transparent_42%)]">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-3xl text-base text-muted-foreground sm:text-lg">
            This is a football survival game built on real fixtures. The rules
            are simple. The decisions are not.
          </p>
      ...
      <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
        <div className="space-y-3">
          ...
          <h2 className="font-display font-semibold text-3xl text-foreground sm:text-4xl">
            A round in 30 seconds
          </h2>
          <p className="max-w-xl text-muted-foreground text-sm sm:text-base">
            Your goal is to make it to the next round with as little risk as
            possible, while saving strong teams for later rounds.
          </p>
        </div>
        ...
        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-muted-foreground text-sm sm:text-base">
              You can join a free pool to learn the flow, or jump into a paid
              pool when you’re ready.
            </p>
          </div>
...
function Step({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-border/80 bg-card/70 p-6 shadow-sm transition hover:border-primary/35 hover:bg-card sm:p-7">
      ...
      <p className="mt-4 font-display font-semibold text-foreground text-xl">
        {title}
      </p>
...
function TimelineItem({ text, title }: { text: string; title: string }) {
  return (
    <li className="grid grid-cols-[22px_1fr] gap-4">
      <span
        aria-hidden
        className="mt-1.5 h-4 w-4 rounded-full border border-border bg-background/80"
      />
      <div>
  ...
  return (
    <details className="group rounded-2xl border border-border/80 bg-card/70 px-5 py-4 shadow-sm transition hover:bg-card">
      <summary className="flex cursor-pointer list-none items-center justify-between gap-4">
        ...
        <span className="font-display font-semibold text-muted-foreground text-sm transition group-open:rotate-45">
          +
        </span>
      </summary>
